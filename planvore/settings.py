"""
Django settings for planvore project.
...
WSGI_APPLICATION = 'planvore.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PORT': config('SERVER_PORT'),                      # Set to empty string for default. Not used with sqlite3.
    }
}
